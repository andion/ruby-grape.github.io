...
* [grape-starter](https://github.com/LeFnord/grape-starter): A tool to quickly create a Grape/Rack API skeleton that also includes grape-swagger for generating documentation.
